...
public class Hotbar
{
    ...
    public static void preload() {
        Hotbar.items.put(HotbarType.QUEUE_JOIN_UNRANKED, new ItemBuilder(Material.IRON_SWORD).name(CC.translate("&9» &b&lJoin &a&lUnranked &b&lQueue &9«")).build());
        Hotbar.items.put(HotbarType.QUEUE_JOIN_RANKED, new ItemBuilder(Material.DIAMOND_SWORD).name(CC.translate("&9» &b&lJoin &a&lRanked &b&lQueue &9«")).build());
        Hotbar.items.put(HotbarType.QUEUE_LEAVE, new ItemBuilder(Material.INK_SACK).durability(1).name(CC.translate("&9» &c&lLeave Queue &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_EVENTS, new ItemBuilder(Material.DIAMOND_AXE).name(CC.translate("&9» &e&lParty Events &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_CREATE, new ItemBuilder(Material.NAME_TAG).name(CC.translate("&9» &d&lParty Create &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_DISBAND, new ItemBuilder(Material.INK_SACK).durability(1).name(CC.translate("&9» &c&lDisband Party &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_SETTINGS, new ItemBuilder(Material.ANVIL).name(CC.translate("&9» &a&lParty Settings &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_LEAVE, new ItemBuilder(Material.INK_SACK).durability(1).name(CC.translate("&9» &c&lParty Leave &9«")).build());
        Hotbar.items.put(HotbarType.PARTY_INFO, new ItemBuilder(Material.PAPER).name(CC.translate("&9» &2&lParty Settings &9«")).build());
        Hotbar.items.put(HotbarType.OTHER_PARTIES, new ItemBuilder(Material.REDSTONE_TORCH_ON).name(CC.translate("&9» &b&lDuel &a&lOther &b&lParties &9«")).build());
        Hotbar.items.put(HotbarType.LEADERBOARDS_MENU, new ItemBuilder(Material.EMERALD).name(CC.translate("&9» &3&lMain Menu &9«")).build());
        Hotbar.items.put(HotbarType.SETTINGS_MENU, new ItemBuilder(Material.ANVIL).name(CC.translate("&9» &e&lSettings &9«")).build());
        Hotbar.items.put(HotbarType.KIT_EDITOR, new ItemBuilder(Material.BOOK).name(CC.translate("&9» &e&lKit Editor &9«")).build());
